...
<?php
    ...
    $tabela_produto = $pdo->prepare("SELECT * FROM chaves WHERE id=:id");
...
<html>
    ...
    <body class="fundo">
        ...
        <div class="container">
            <h1 style="text-align: center;">Editar chaves</h1>
            <br>
        <footer>
            <form action="CRUD/update_chaves.php" method="post">
            ...
            <div class="form-group offset-md-3">
                ...
                <div class="form-group offset-md-3">
                <div class="col-md-6">
                    <input type="submit" class="btn btn-success" value="Editar chaves">
                    <a href="tabela_chaves.php" type="button" class="btn btn-primary float-end">Voltar</a>
                </div> 
               </div>

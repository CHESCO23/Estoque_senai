...
<html>
    ...
    <body class="fundo">
        ...
        <div class="container">
            <h1 style="text-align: center;">Editar emprestimos</h1>
            <br>
        <footer>
            <form action="CRUD/update_emprestimo.php" method="post">
            ...
            <div class="form-group offset-md-3">
                ...
                <div class="form-group offset-md-3">
                <div class="col-md-6">
                    <input type="submit" class="btn btn-success" value="Editar emprestimo">
                    <a href="tabela_emprestimos.php" type="button" class="btn btn-primary float-end">Voltar</a>
                </div> 
               </div>

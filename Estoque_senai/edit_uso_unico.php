...
<html>
    ...
    <body class="fundo">
        ...
        <div class="container">
            <h1 style="text-align: center;">Editar uso único</h1>
            <br>
        <footer>
            <form action="CRUD/update_uso_unico.php" method="post">
            ...
            <div class="form-group offset-md-3">
                ...
                <div class="col-md-6">
                    ...
                    <a href="tabela_uso_unico.php" type="button" class="btn btn-primary float-end">Voltar</a>
                </div> 
               </div>
